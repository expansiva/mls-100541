/// <mls shortName="internalTabbable" project="100541" enhancement="_blank" />
				
import { offsetParent } from './_100541_internalComposedOffsetPosition'
...
export const getTabbableElements = (root: HTMLElement | ShadowRoot) => {
  ...
  function walk(el: HTMLElement | ShadowRoot) {
    ...
    [...el.children as any].forEach((e: HTMLElement) => walk(e));
  }
