...
export class ImageComparer extends LitElement {
    ...
    render() {
      ...
      >
            ...
            ${hasClearIcon
                ? html`
                  <button
                    ...
                    tabindex="-1"
                  >
                    <icon-100541 name="x-circle-fill" library="default"></icon-100541>
                  </button>
                `
                : ''}
                    ...
                    ${this.passwordVisible
                        ? html`
                          <slot name="show-password-icon">
                            <icon-100541 name="eye-slash" library="default"></icon-100541>
                          </slot>
                        `
                        : html`
                          <slot name="hide-password-icon">
                            <icon-100541 name="eye" library="default"></icon-100541>
                          </slot>
                        `}
                  </button>
                `
        ...
        >
          <label name="help-text">${this.helpText}</label>
        </div>
      </div>
    `;
    }
