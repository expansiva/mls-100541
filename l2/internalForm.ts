/// <mls shortName="internalForm" project="100541" enhancement="_blank" />
...
//
export const formCollections: WeakMap<HTMLFormElement, Set<any>> = new WeakMap();
...
export interface FormControlControllerOptions {
  ...
  value: (input: any) => unknown | unknown[];
  /** A function that returns the form control's default value. */
  defaultValue: (input: any) => unknown | unknown[];
  ...
  setValue: (input: any, value: unknown) => void;
  /**
...
export class FormControlController implements ReactiveController {
  host: any & ReactiveControllerHost;
  form?: HTMLFormElement | null;
  options: FormControlControllerOptions;

  constructor(host: ReactiveControllerHost & any, options?: Partial<FormControlControllerOptions>) {
  ...
  private attachForm(form?: HTMLFormElement) {
    if (form) {
      ...
      if (formCollections.has(this.form)) {
        ...
        formCollections.set(this.form, new Set<any>([this.host]));
      }
  ...
  private handleFormData = (event: any) => {
  ...
  private reportFormValidity = () => {
    ...
    if (this.form && !this.form.noValidate) {
      ...
      const elements:any = this.form.querySelectorAll<HTMLInputElement>('*');
  ...
  private setUserInteracted(el: any, hasInteracted: boolean) {
    if (hasInteracted) {
