/// <mls shortName="litReactiveElement" project="100541" enhancement="_blank" />
...
import {
  ...
  CSSResultGroup,
  CSSResultOrNative,
} from '_100541_litCssTag';
import type {
  ReactiveController,
  ReactiveControllerHost,
} from '_100541_litReactiveController';

// In the Node build, this import will be injected by Rollup:
// import {HTMLElement, customElements} from '@lit-labs/ssr-dom-shim';

export * from '_100541_litCssTag';
export type {
  ReactiveController,
  ReactiveControllerHost,
} from '_100541_litReactiveController';
  ...
  implements ReactiveControllerHost
{
  ...
  protected static finalizeStyles(
    ...
    if (Array.isArray(styles)) {
      ...
      const set = new Set((styles as Array<any>)[('flat' as any)](Infinity).reverse());
