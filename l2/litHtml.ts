/// <mls shortName="litHtml" project="100541" enhancement="_blank" />
...
const trustedTypes = (global as unknown as Partial<Window> as any).trustedTypes;
...
class Template {
  ...
  constructor(
    ...
    if (type === SVG_RESULT) {
      ...
      const svgElement = content.firstChild! as any;
      svgElement.remove();
