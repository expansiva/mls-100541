/// <mls shortName="internalShoelaceElement" project="100541" enhancement="_blank" />
...
export default class ShoelaceElement extends LitElement {
  ...
  static define(name: string, elementConstructor = this, options: ElementDefinitionOptions = {}) {
    ...
    if (!currentlyRegisteredConstructor) {
      customElements.define(name, class extends elementConstructor {} as unknown as any, options);
      return;
    }
